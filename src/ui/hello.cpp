...
void ui_draw_hello::draw(lv_obj_t*cont){
	...
	lv_obj_set_grid_cell(btn_reboot,LV_GRID_ALIGN_STRETCH,0,1,LV_GRID_ALIGN_CENTER,2,1);
	auto f2=std::bind(&ui_draw_hello::btn_reboot_cb,this,std::placeholders::_1);
	lv_obj_add_event_func(btn_reboot,f2,LV_EVENT_CLICKED);
	...
	lv_obj_set_grid_cell(btn_shutdown,LV_GRID_ALIGN_STRETCH,0,1,LV_GRID_ALIGN_CENTER,3,1);
	auto f3=std::bind(&ui_draw_hello::btn_shutdown_cb,this,std::placeholders::_1);
	lv_obj_add_event_func(btn_shutdown,f3,LV_EVENT_CLICKED);
