...
#define LV_ASSERT_HANDLER_INCLUDE "lv_custom.h"
#define LV_ASSERT_HANDLER log_assert_failed("lvgl assert failed");
...
#define LV_CACHE_DEF_SIZE       0x100000
...
#define LV_ATTRIBUTE_MEM_ALIGN __attribute__((sizeof(void*)))
 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE extern lv_font_t*gui_def_font;

/** Always set a default font */
#define LV_FONT_DEFAULT gui_def_font
